...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid meet">
  <!-- 하늘 (단색 레이어) -->
  <rect x="0" y="0" width="1200" height="580" fill="#BDE3F5"/>
  <rect x="0" y="330" width="1200" height="250" fill="#D9F0FA" opacity="0.6"/>
  ...
  <!-- ★차이5(L1): 구름 — B에서는 사라짐 -->
  <g data-diff="5" data-cx="400" data-cy="105" data-r="80">${D1 ? '' : `
    <g fill="#FFFFFF" opacity="0.95">
      <circle cx="360" cy="110" r="28"/><circle cx="400" cy="94" r="36"/><circle cx="440" cy="112" r="26"/>
      <rect x="352" y="104" width="98" height="34" rx="17"/>
    </g>`}
  </g>

  <!-- ★차이4(L1): 익룡 — 날개 색 (분홍 → 연두) -->
  <g data-diff="4" data-cx="862" data-cy="172" data-r="95">
    <path d="M852 190 Q790 130 726 152 Q782 182 838 200 Z" fill="${D1 ? '#9BD98A' : '#F5A8C6'}"/>
    <path d="M872 190 Q934 130 998 152 Q942 182 886 200 Z" fill="${D1 ? '#9BD98A' : '#F5A8C6'}"/>
    <ellipse cx="862" cy="196" rx="26" ry="16" fill="#F8E3C2"/>
    <circle cx="890" cy="180" r="13" fill="#F8E3C2"/>
    <polygon points="884,172 870,152 892,166" fill="${D1 ? '#7BC26E' : '#E88CAE'}"/>
    <polygon points="900,176 924,182 900,188" fill="#F2A33C"/>
    <circle cx="891" cy="178" r="3" fill="#5A4632"/>
    <path d="M886 188 Q891 191 896 188" stroke="#5A4632" stroke-width="2.5" fill="none" stroke-linecap="round"/>
  </g>
  ...
  <g data-diff="2" data-cx="604" data-cy="155" data-r="78">${D1 ? '' : `
    <g fill="#F2EEE8" opacity="0.95">
      <circle cx="592" cy="202" r="20"/>
      <circle cx="620" cy="172" r="27"/>
      <circle cx="590" cy="140" r="22"/>
      <circle cx="618" cy="108" r="16"/>
    </g>`}
  </g>
  ...
  <g data-find="lizard" data-label="도마뱀">
    <path d="M496 420 Q510 406 526 412 Q542 418 550 410 Q562 400 572 390" stroke="#58B368" stroke-width="11" fill="none" stroke-linecap="round"/>
    <path d="M566 394 Q580 384 590 372" stroke="#58B368" stroke-width="6" fill="none" stroke-linecap="round"/>
    <circle cx="492" cy="418" r="10" fill="#58B368"/>
    <circle cx="489" cy="415" r="2.5" fill="#2E5A38"/>
    <path d="M506 424 L500 434 M518 420 L516 432 M540 416 L536 428 M552 410 L552 422" stroke="#3F8F50" stroke-width="4" stroke-linecap="round"/>
  </g>
  ...
  <g>
    ...
    <g data-diff="3" data-cx="1084" data-cy="362" data-r="60">${D1 ? `
      <circle cx="1084" cy="366" r="14" fill="#8A5636"/><circle cx="1079" cy="361" r="4" fill="#A87B54"/>` : `
      <circle cx="1064" cy="360" r="14" fill="#8A5636"/><circle cx="1059" cy="355" r="4" fill="#A87B54"/>
      <circle cx="1104" cy="360" r="14" fill="#8A5636"/><circle cx="1099" cy="355" r="4" fill="#A87B54"/>
      <circle cx="1084" cy="382" r="14" fill="#8A5636"/><circle cx="1079" cy="377" r="4" fill="#A87B54"/>`}
    </g>
  </g>

  <!-- 숨은그림 L3: 도롱뇽 (야자수 아래 풀밭, 올리브 보호색) -->
  <g data-find="salamander" data-label="도롱뇽" data-level="3">
    <circle cx="1110" cy="556" r="6.5" fill="#A0B860"/>
    <circle cx="1108" cy="554" r="1.8" fill="#4A5A28"/>
    <path d="M1115 558 Q1124 552 1131 556 Q1139 560 1144 551" stroke="#A0B860" stroke-width="8" fill="none" stroke-linecap="round"/>
    <circle cx="1123" cy="555" r="2" fill="#E8894B"/><circle cx="1132" cy="557" r="2" fill="#E8894B"/>
    <path d="M1119 561 L1115 569 M1130 562 L1128 570" stroke="#7E9448" stroke-width="3" stroke-linecap="round"/>
  </g>
  ...
  <g data-diff="1" data-cx="250" data-cy="500" data-r="130">
    <path d="M158 566 Q92 580 84 628" stroke="${D1 ? '#8FB8E8' : '#74C561'}" stroke-width="26" fill="none" stroke-linecap="round"/>
    <rect x="175" y="598" width="34" height="64" rx="15" fill="${D1 ? '#8FB8E8' : '#74C561'}"/>
    <rect x="235" y="608" width="34" height="58" rx="15" fill="${D1 ? '#8FB8E8' : '#74C561'}"/>
    <rect x="284" y="602" width="34" height="62" rx="15" fill="${D1 ? '#8FB8E8' : '#74C561'}"/>
    <ellipse cx="245" cy="560" rx="108" ry="64" fill="${D1 ? '#8FB8E8' : '#74C561'}"/>
    <ellipse cx="245" cy="584" rx="68" ry="32" fill="${D1 ? '#CBDFF6' : '#C9EAAA'}"/>
    <path d="M298 540 Q335 420 356 318" stroke="${D1 ? '#8FB8E8' : '#74C561'}" stroke-width="44" fill="none" stroke-linecap="round"/>
    <circle cx="360" cy="300" r="28" fill="${D1 ? '#8FB8E8' : '#74C561'}"/>
    <circle cx="196" cy="528" r="10" fill="${D1 ? '#CBDFF6' : '#C9EAAA'}"/>
    <circle cx="248" cy="516" r="12" fill="${D1 ? '#CBDFF6' : '#C9EAAA'}"/>
    <circle cx="350" cy="293" r="4.5" fill="#3B4A2E"/><circle cx="371" cy="293" r="4.5" fill="#3B4A2E"/>
  ...
  <g data-diff="18" data-level="3" data-cx="300" data-cy="540" data-r="45">${D3 ? '' : `<circle cx="300" cy="540" r="9" fill="${D1 ? '#CBDFF6' : '#C9EAAA'}"/>`}
  </g>
  ...
  <g>
    ...
    <circle cx="670" cy="614" r="5" fill="#5A3E2B"/><circle cx="696" cy="614" r="5" fill="#5A3E2B"/>
    <path d="M668 632 Q682 641 696 632" stroke="#5A3E2B" stroke-width="4" fill="none" stroke-linecap="round"/>
    <circle cx="662" cy="626" r="6" fill="#F5A8C6" opacity="0.75"/>
  </g>
  ...
  <!-- 꽃 -->
  <g>
    ${[[300, 758, '#F9A8C6'], [640, 766, '#C9A8F0'], [1156, 626, '#FFB27A']].map(([x, y, c]) => `
    <g>
      <circle cx="${x - 11}" cy="${y}" r="8" fill="${c}"/><circle cx="${x + 11}" cy="${y}" r="8" fill="${c}"/>
      <circle cx="${x}" cy="${y - 11}" r="8" fill="${c}"/><circle cx="${x}" cy="${y + 11}" r="8" fill="${c}"/>
    ...
    <g data-diff="9" data-level="2" data-cx="86" data-cy="640" data-r="45">
      ...
      <circle cx="86" cy="640" r="7" fill="#FFD93D"/>
    </g>
  </g>
  ...
  hidden: [
    ...
    },
    {
      ...
      icon: `<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="27" cy="13" r="2" fill="#1E4A5C"/><circle cx="33" cy="13" r="2" fill="#1E4A5C"/></svg>`
    },
    {
      id: 'turtle', label: '거북이',
      icon: `<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="51" cy="34" r="7" fill="#A8D998"/><circle cx="53" cy="32" r="2" fill="#2E5A38"/></svg>`
    },
    {
      id: 'lizard', label: '도마뱀',
      icon: `<svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
