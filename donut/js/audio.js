...
window.Audio2 = (() => {
  ...
  const sfx = {
    ...
    pop()     { tone(560, 0, 0.06, 0.3, 'square'); tone(920, 0.05, 0.12, 0.25, 'sine'); },
    good()    { tone(523, 0, 0.12, 0.3); tone(659, 0.1, 0.12, 0.3); tone(784, 0.2, 0.2, 0.3); },
    bad()     { tone(300, 0, 0.14, 0.16, 'sine'); },  // 부드러운 안내음(무벌점)
    fanfare() { [523, 659, 784, 1047].forEach((ff, i) => tone(ff, i * 0.12, 0.25, 0.3)); tone(1319, 0.5, 0.45, 0.3); },
  };
