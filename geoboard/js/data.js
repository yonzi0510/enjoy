...
window.GeoboardData = (() => {
  ...
  const PUZZLES = [
    ...
    p(2, 's2-04', [band('green',  [[0, 2], [3, 2], [3, 1], [5, 3], [3, 5], [3, 4], [0, 4]])]), // 오른쪽 화살표
    ...
    p(2, 's2-07', [band('blue',   [[0, 4], [0, 3], [1, 3], [2, 2], [4, 2], [5, 3], [5, 4]])]), // 자동차
    p(2, 's2-08', [band('yellow', [[0, 4], [0, 2], [1, 3], [2, 2], [3, 3], [4, 2], [4, 4]])]), // 왕관
    p(2, 's2-09', [band('orange', [[2, 0], [4, 1], [4, 4], [2, 5], [0, 4], [0, 1]])]),  // 육각형
    p(2, 's2-10', [band('red',    [[2, 1], [1, 0], [0, 1], [2, 4], [4, 1], [3, 0]])]),  // 하트
    ...
    p(3, 's3-04', [band('yellow', [[0, 4], [0, 1], [1, 2], [2, 1], [3, 2], [4, 1], [4, 4]]),
                   band('red',    [[1, 3], [3, 3], [2, 2]])]),                          // 왕관 + 보석
