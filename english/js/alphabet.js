...
window.AlphabetData = (() => {
  ...
  const UPPER = [
    ...
    { ch: 'C', name: '씨', sound: '크',
      strokes: [arc(51, 50, 28, 38, -55, -305)],
    ...
    { ch: 'G', name: '지', sound: '그',
      ...
      strokes: [arc(51, 50, 28, 38, -55, -315), [[71, 77], [71, 54], [54, 54]]],
  ...
  const LOWER = [
    ...
    { ch: 'f', name: '에프', sound: '프',
      strokes: [join(arc(46, 26, 16, 14, 0, -180), [[30, 26], [30, 88]]), [[16, 44], [44, 44]]],
      words: [{ w: 'fox', k: '여우', e: '🦊' }, { w: 'fish', k: '물고기', e: '🐟' }, { w: 'flower', k: '꽃', e: '💐' }] },
    ...
    { ch: 'i', name: '아이', sound: '이',
      ...
      strokes: [[[48, 44], [48, 88]], [[48, 26], [48, 30]]],
      words: [{ w: 'ice cream', k: '아이스크림', e: '🍦' }, { w: 'ice', k: '얼음', e: '🧊' }, { w: 'island', k: '섬', e: '🏝️' }] },

    { ch: 'j', name: '제이', sound: '즈',
      strokes: [join([[52, 44], [52, 86]], arc(38, 86, 14, 12, 0, 145)), [[52, 26], [52, 30]]],
      words: [{ w: 'juice', k: '주스', e: '🧃' }, { w: 'jelly', k: '젤리', e: '🍬' }, { w: 'jump', k: '점프', e: '🤸' }] },

    { ch: 'k', name: '케이', sound: '크',
      strokes: [[[30, 12], [30, 88]], [[62, 46], [32, 64]], [[32, 64], [64, 88]]],
      words: [{ w: 'key', k: '열쇠', e: '🔑' }, { w: 'kiwi', k: '키위', e: '🥝' }, { w: 'koala', k: '코알라', e: '🐨' }] },
    ...
    { ch: 'r', name: '알', sound: '르',
      strokes: [[[32, 40], [32, 88]], arc(46, 54, 14, 14, 180, 350)],
      words: [{ w: 'rabbit', k: '토끼', e: '🐰' }, { w: 'rainbow', k: '무지개', e: '🌈' }, { w: 'robot', k: '로봇', e: '🤖' }] },
