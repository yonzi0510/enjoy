/* 마음 놀이터 데이터 — 얼굴 부품(눈썹10·눈11·입11) · 마음 12종 · 장면 27개(묶음 3 × 9) · 도움 카드 108장
 *
 * ⚠️ 이 놀이에는 **정답이 없다.**
...
window.HeartData = (() => {
  ...
  const PARTS = {
    brow: {
      ...
      list: [
        ...
        /* ── 2026-08 5종 추가: "표정 조합이 한정적" 지적 — 부위마다 +5. 새 도형은
         * 기존과 실루엣이 겹치지 않게 렌더링 확인 후 넣었다(스크린샷 검수). */
        { id: 'angry', name: '화난 눈썹',
          fd: 'M26.07 28.3 L27.93 29.93 L29.79 31.55 L31.65 33.18 L33.51 34.81 L35.36 36.43 L37.22 38.06 L39.08 39.69 L42.92 34.31 L40.78 33.08 L38.64 31.85 L36.49 30.62 L34.35 29.39 L32.21 28.16 L30.07 26.93 L27.93 25.7 Z ' +
              'M73.93 28.3 L72.07 29.93 L70.21 31.55 L68.35 33.18 L66.49 34.81 L64.64 36.43 L62.78 38.06 L60.92 39.69 L57.08 34.31 L59.22 33.08 L61.36 31.85 L63.51 30.62 L65.65 29.39 L67.79 28.16 L69.93 26.93 L72.07 25.7 Z' },
        { id: 'short', name: '짧은 눈썹',
          fd: 'M33.19 35.19 L34.49 35.17 L35.79 35.16 L37.09 35.14 L38.39 35.13 L39.69 35.11 L40.99 35.1 L42.29 35.08 L41.71 29.92 L40.44 30.19 L39.17 30.46 L37.9 30.73 L36.63 31 L35.36 31.27 L34.08 31.54 L32.81 31.81 Z ' +
              'M66.81 35.19 L65.51 35.17 L64.21 35.16 L62.91 35.14 L61.61 35.13 L60.31 35.11 L59.01 35.1 L57.71 35.08 L58.29 29.92 L59.56 30.19 L60.83 30.46 L62.1 30.73 L63.37 31 L64.64 31.27 L65.92 31.54 L67.19 31.81 Z' },
        { id: 'worry', name: '걱정 눈썹',
          fd: 'M27.6 32.37 L29.69 31.66 L31.57 31.38 L33.35 31.46 L35.07 31.88 L36.78 32.63 L38.5 33.72 L40.39 35.29 L43.61 30.71 L41.22 29.26 L38.65 28.15 L36.07 27.51 L33.51 27.35 L31 27.68 L28.6 28.47 L26.4 29.63 Z ' +
              'M72.4 32.37 L70.31 31.66 L68.43 31.38 L66.65 31.46 L64.93 31.88 L63.22 32.63 L61.5 33.72 L59.61 35.29 L56.39 30.71 L58.78 29.26 L61.35 28.15 L63.93 27.51 L66.49 27.35 L69 27.68 L71.4 28.47 L73.6 29.63 Z' },
        { id: 'bold', name: '두꺼운 눈썹',
          fd: 'M27.17 35.09 L29.32 35.01 L31.47 34.92 L33.61 34.84 L35.76 34.75 L37.91 34.67 L40.05 34.58 L42.2 34.49 L41.8 28.51 L39.66 28.71 L37.52 28.91 L35.38 29.11 L33.24 29.31 L31.11 29.51 L28.97 29.71 L26.83 29.91 Z ' +
              'M72.83 35.09 L70.68 35.01 L68.53 34.92 L66.39 34.84 L64.24 34.75 L62.09 34.67 L59.95 34.58 L57.8 34.49 L58.2 28.51 L60.34 28.71 L62.48 28.91 L64.62 29.11 L66.76 29.31 L68.89 29.51 L71.03 29.71 L73.17 29.91 Z' },
        /* 한쪽만 치켜뜬 — 왼쪽은 'flat', 오른쪽은 'up'을 그대로 재사용(의아함) */
        { id: 'quizzical', name: '의아한 눈썹',
          fd: 'M28 34 L30.17 34.32 L32.33 34.63 L34.5 34.95 L36.67 35.27 L38.83 35.58 L41 35.9 L41 30.1 L38.83 30.42 L36.67 30.73 L34.5 31.05 L32.33 31.37 L30.17 31.68 L28 32 Z ' +
              'M71.58 36.91 L69.28 36.2 L66.98 35.48 L64.68 34.77 L62.38 34.06 L60.08 33.35 L57.78 32.63 L60.22 27.37 L62.25 28.65 L64.28 29.94 L66.32 31.23 L68.35 32.52 L70.39 33.8 L72.42 35.09 Z' },
      ],
    },
    eyes: {
      ...
      list: [
        ...
        { id: 'closed', name: '감은 눈',   d: 'M27 47 Q34 48.2 41 47 M59 47 Q66 48.2 73 47' },
        { id: 'heart',  name: '하트 눈',   fd: 'M34 50 C28 44.8 30.5 39.4 34 43 C37.5 39.4 40 44.8 34 50 Z M66 50 C72 44.8 69.5 39.4 66 43 C62.5 39.4 60 44.8 66 50 Z' },
        { id: 'star',   name: '반짝이는 눈', fd: 'M34 40 L35.56 45.44 L41 47 L35.56 48.56 L34 54 L32.44 48.56 L27 47 L32.44 45.44 Z M66 40 L64.44 45.44 L59 47 L64.44 48.56 L66 54 L67.56 48.56 L73 47 L67.56 45.44 Z' },
        { id: 'sleepy', name: '졸린 눈',   fd: 'M27.5 47 A6.5 6.5 0 0 0 40.5 47 Z M59.5 47 A6.5 6.5 0 0 0 72.5 47 Z' },
        { id: 'narrow', name: '찡그린 눈', d: 'M27 44.5 L34 49.5 L41 44.5 M59 44.5 L66 49.5 L73 44.5' },
      ],
    },
    mouth: {
      ...
      list: [
        ...
        { id: 'grin',   name: '활짝 웃는 입', fd: 'M34 62 Q50 79 66 62 Q50 69 34 62 Z', d: 'M39 66 H61' },
        { id: 'tongue', name: '메롱 입',   d: 'M36 63 Q50 74 64 63', fd: 'M44 68 Q50 79 56 68 Q50 72 44 68 Z' },
        { id: 'teeth',  name: '앙다문 입', fd: 'M38 66 H62 V71 H38 Z', d: 'M44 66 V71 M50 66 V71 M56 66 V71' },
        { id: 'o',      name: '오 하는 입', fd: 'M44.5 65.5 a5.5 5.5 0 1 0 11 0 a5.5 5.5 0 1 0 -11 0' },
        { id: 'smirk',  name: '씨익 웃는 입', d: 'M36 67 Q48 70 56 67 Q60 63 64 58' },
      ],
    },
  };
  ...
  /* 아이가 손대는 얼굴판 전용 — 머리만 떠 있으면 "이게 얼굴인가?" 헷갈린다는
   * 지적(2026-08)에 몸통을 붙였다. 친구(friendSvg)와 같은 몸통·팔 그림을 그대로 쓴다 —
   * 카드 속 친구와 같은 그림 언어라야 "인형을 만든다"는 게 한눈에 보인다. */
  function bodySvg(sel, opts) {
    const o = opts || {};
    const cls = 'face-svg body-svg' + (o.cls ? ' ' + o.cls : '');
    return `<svg class="${cls}" viewBox="20 6 80 114" width="100%" xmlns="http://www.w3.org/2000/svg"` + faceAttrs(sel) + `>` +
      ...
      `<g transform="translate(32,14) scale(0.56)">${faceInner(sel, o)}</g>` +
      `</svg>`;
  }
  ...
  return {
    PARTS, SLOTS, SLOT_COLOR, partMeta, partPaths, faceSvg, bodySvg,
    MOODS, moodMeta,
    ICONS, iconSvg,
